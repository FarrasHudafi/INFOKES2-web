...
const Footer = () => {
  return (
    <footer className="bg-gray-100">
        <div className="mx-auto max-w-5xl justify-center text-center flex flex-col px-4 py-16 sm:px-6 lg:px-8">
            ...
            Kami berdedikasi memberikan layanan kesehatan terbaik dengan menghadirkan dokter-dokter profesional dan terpercaya. Solusi kesehatan dalam satu klik.
            </p>
